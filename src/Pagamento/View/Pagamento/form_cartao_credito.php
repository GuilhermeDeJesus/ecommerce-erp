...
.jp-card.jp-card-safari.jp-card-identified .jp-card-back:before,
	...
	background-image: repeating-linear-gradient(45deg, hsla(0, 0%, 100%, 0)
		1px, hsla(0, 0%, 100%, .03) 2px, hsla(0, 0%, 100%, .04) 3px,
		hsla(0, 0%, 100%, .05) 4px),
		repeating-linear-gradient(135deg, hsla(0, 0%, 100%, .05) 1px,
		hsla(0, 0%, 100%, 0) 2px, hsla(0, 0%, 100%, .04) 3px,
		hsla(0, 0%, 100%, .03) 4px),
		repeating-linear-gradient(90deg, hsla(0, 0%, 100%, 0) 1px,
		hsla(0, 0%, 100%, .03) 2px, hsla(0, 0%, 100%, .04) 3px,
		hsla(0, 0%, 100%, .05) 4px),
		repeating-linear-gradient(210deg, hsla(0, 0%, 100%, 0) 1px,
		hsla(0, 0%, 100%, .03) 2px, hsla(0, 0%, 100%, .04) 3px,
		hsla(0, 0%, 100%, .05) 4px),
		linear-gradient(-25deg, hsla(0, 0%, 100%, 0) 50%,
		hsla(0, 0%, 100%, .2) 70%, hsla(0, 0%, 100%, 0) 90%)
}
...
.jp-card.jp-card-ie-10.jp-card-flipped .jp-card-back, .jp-card.jp-card-ie-10.jp-card-flipped .jp-card-front,
	.jp-card.jp-card-ie-11.jp-card-flipped .jp-card-back, .jp-card.jp-card-ie-11.jp-card-flipped .jp-card-front
	{
...
.jp-card-logo.jp-card-visaelectron:after, .jp-card-logo.jp-card-visaelectron:before
	{
	content: " ";
	display: block;
	width: 100%;
...
.jp-card-logo.jp-card-elo .e, .jp-card-logo.jp-card-elo .l,
...
.jp-card-logo.jp-card-jcb, .jp-card-logo.jp-card-jcb>div {
...
.jp-card.jp-card-jcb.jp-card-identified .jp-card-back:before, .jp-card.jp-card-jcb.jp-card-identified .jp-card-front:before
	{
...
.jp-card.jp-card-identified .jp-card-back:before, .jp-card.jp-card-identified .jp-card-front:before
	...
	background-image: repeating-linear-gradient(45deg, hsla(0, 0%, 100%, 0)
		...
		hsla(0, 0%, 100%, .03) 2px, hsla(0, 0%, 100%, .04) 3px,
		hsla(0, 0%, 100%, .05) 4px),
		repeating-radial-gradient(circle at 30% 30%, hsla(0, 0%, 100%, 0) 1px,
		hsla(0, 0%, 100%, .03) 2px, hsla(0, 0%, 100%, .04) 3px,
		hsla(0, 0%, 100%, .05) 4px),
		repeating-radial-gradient(circle at 70% 70%, hsla(0, 0%, 100%, 0) 1px,
		hsla(0, 0%, 100%, .03) 2px, hsla(0, 0%, 100%, .04) 3px,
		hsla(0, 0%, 100%, .05) 4px),
		repeating-radial-gradient(circle at 90% 20%, hsla(0, 0%, 100%, 0) 1px,
		hsla(0, 0%, 100%, .03) 2px, hsla(0, 0%, 100%, .04) 3px,
		hsla(0, 0%, 100%, .05) 4px),
		repeating-radial-gradient(circle at 15% 80%, hsla(0, 0%, 100%, 0) 1px,
		hsla(0, 0%, 100%, .03) 2px, hsla(0, 0%, 100%, .04) 3px,
		hsla(0, 0%, 100%, .05) 4px),
		linear-gradient(-25deg, hsla(0, 0%, 100%, 0) 50%,
		hsla(0, 0%, 100%, .2) 70%, hsla(0, 0%, 100%, 0) 90%);
	...
	<div id="credit-card">
		...
		<header>
			<img style="margin-left: -25px; margin-bottom: 15px;"
				...
				class="reference"> Número de referência : <span>121461995</span>
			</small><span><h1>Métodos de pagamento disponíveis :</h1>
				<ul class="card-methods">
					<li><img src="public/img/visa.png"></li>
					<li><img src="public/img/mastercard.png"></li>
					<li><img src="public/img/amex.png"></li>
					<li><img src="public/img/diners.png"></li>
					<li><img src="public/img/elo.png"></li>
					<li><img src="public/img/hipercard.png"></li>
					<li><img src="public/img/mercadolivre.png"></li>
				</ul></span>
		</header>
		...
		<section class="credit-card">
			<form>
				<ul class="form-list col-2 half left icon-featured">
					<li class="full "><label>Nome do titular do cartão</label>
						<div class="input-container">
							<div class="icon" data-icon="name"></div>
							<input type="text" autocorrect="false" name="name"
								id="cc-holder-name" placeholder="Nome completo">
						</div></li>
					<li class="full "><label>Número do cartão</label>
						<div class="input-container">
							<div class="icon" data-icon="number"></div>
							<input type="tel" autocorrect="false" name="number"
								id="cc-number" placeholder="Número do cartão">
						</div></li>
					<li class="mrg "><label>Código de segurança</label>
						<div class="input-container">
							<div class="icon" data-icon="cvv"></div>
							<input type="tel" autocorrect="false" name="cvv" id="cc-cvc"
								placeholder="CVV">
						</div></li>
					<li class="inputs-1 inp"><ul>
							<li class="full "><label>Validade</label>
								<div class="input-container">
									<div class="icon" data-icon="calendar"></div>
									<input type="tel" autocorrect="false" name="exp" id="cc-exp"
										placeholder="MM/AA">
								</div></li>
						</ul></li>
					<li class="full "><label>Parcelas</label>
						<div class="input-container">
							<div class="select-wrapper disabled">
								<span>▼</span><select name="installments" id="cc-installments"
									disabled=""><option
										value="Primeiro digite seu número de cartão">Primeiro digite
										seu número de cartão</option></select>
							</div>
						</div></li>
				</ul>
			</form>
			<div class="card-wrapper half right" data-jp-card-initialized="true">
						...
						<div class="jp-card-front">
							...
							<div class="jp-card-lower">
								...
								<div class="jp-card-expiry jp-card-display"
									data-before="Mês/Ano" data-after="VALID DATE">••/••</div>
							</div>
						</div>
		...
		<section class="checkout-wrapper">
			<div class="left transparent checkout ">
				<ul>
					<li>Valor <small> R$ 193.46 </small>
					</li>
					<li>Taxas <small> R$ 0.74 </small>
					</li>
					<li class="total"><small>PAGAMENTO TOTAL R$ 194.20 </small>
					</li>
				</ul>
			</div>
		</section>
		<footer>
			<a class="btn color-default"><span class="lock-icon"></span> Pagar R$
				194.20</a><a class="btn ghost">Voltar</a>
		</footer>
		<div class="master-alert fade-in desktop" style="display: none;">
			<p></p>
		</div>
		<p class="out-contact">Contacte-nos através direct@dlocal.com</p>
		</main>
	</div>
	<input type="hidden" name="deviceId" id="deviceId">
	<script src="public/js/card/jsbn.js"></script>
	<script src="public/js/card/prng4.js"></script>
	<script src="public/js/card/rng.js"></script>
	<script src="public/js/card/rsa.js"></script>
	<script type="text/javascript" src="public/js/card/vendor.js?v=10"></script>
	<script type="text/javascript" src="public/js/card/credit-card.js?v=10"></script>
</body>
</html>