...
<title>Importar Códigos de Rastreamento</title>
				...
				<div class="">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									<h2>Importar Códigos de Rastreamento</h2>
								...
								<div class="x_content">
									...
									<form
										action="?m=sistema&c=venda&a=importarCodigosDeRastreamento"
										class="dropzone"></form>
									<br /> <br />
								</div>
							</div>
