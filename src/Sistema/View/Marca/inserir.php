									...
									<div class="" role="tabpanel" data-example-id="togglable-tabs">
										...
										<div id="myTabContent" class="tab-content">
											...
											<div role="tabpanel" class="tab-pane fade active in"
												...
												<form action="?m=sistema&c=marca&a=cadastrar" method="post"
													enctype="multipart/form-data"
													class="form-horizontal form-label-left">
													<div class="row">
														<div class="col-md-8 col-sm-12 col-xs-12 form-group">
															<input type="hidden" name="id"
																value="<?= (isset($data['marca'][0]['id'])) ? $data['marca'][0]['id'] : '' ?>" />
															<label class="control-label col-md-3 col-sm-3 col-xs-12">Marca</label>
															<div class="col-md-9 col-sm-9 col-xs-12">
																<input type="text" name="nome"
																	value="<?= (isset($data['marca'][0]['nome'])) ? $data['marca'][0]['nome'] : '' ?>"
	...
	<script>
      $(document).ready(function() {
        ...
        $(".select2_multiple").select2({
          ...
          placeholder: "Limite de 20 itens",
          allowClear: true
        });
      });
    </script>
