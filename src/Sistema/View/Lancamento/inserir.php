...
<body class="nav-md">
							...
							<div class="x_panel">
								...
								<div class="x_content">
									<div class="" role="tabpanel" data-example-id="togglable-tabs">
										...
										<form action="?m=sistema&c=lancamento&a=cadastrar"
											...
											<div id="myTabContent" class="tab-content">
												...
												<div role="tabpanel" class="tab-pane fade active in"
													...
													<input type="hidden" name="id"
														value="<?= (isset($data['lancamento'][0]['id'])) ? $data['lancamento'][0]['id'] : '' ?>" />
													<div class="row">
														<div class="col-md-8 col-sm-12 col-xs-12 form-group">
															<label class="control-label col-md-3 col-sm-3 col-xs-12">Tipo</label>
															<div class="col-md-9 col-sm-9 col-xs-12">
																<select class="form-control" name=id_tipo_lancamento
																	required="required">
                                        							<?php foreach ($data['tipo_lancamento'] as $pval => $pkey) { ?>
                                        							<option
														...
														<div class="col-md-8 col-sm-12 col-xs-12 form-group">
															...
															<div class="col-md-9 col-sm-9 col-xs-12">
																<select class="select2_group form-control" name=id_produto
																	required="required" style="height: 35px !important;">
																	<option value="0">-</option>
                                        							<?php foreach ($data['produtos'] as $pval => $pkey) { ?>
                                        							<option
																		value="<?=$pkey['id']?>"><?=$pkey['descricao']?></option>
                                        							<?php } ?>
                                        						</select>
															</div>
														</div>
														<div class="col-md-8 col-sm-12 col-xs-12 form-group">
															...
															<div class="col-md-9 col-sm-9 col-xs-12">
																<input type="date" name="data"
																	value="<?= (isset($data['lancamento'][0]['data'])) ? $data['lancamento'][0]['data'] : '' ?>"
														...
														<div class="col-md-8 col-sm-12 col-xs-12 form-group">
															...
															<div class="col-md-9 col-sm-9 col-xs-12">
																<input type="text" name="valor"
																	value="<?= (isset($data['lancamento'][0]['valor'])) ? $data['lancamento'][0]['valor'] : '' ?>"
	...
	<script>
		$("input[name='valor']").maskMoney({prefix:'R$ ', allowNegative: true, thousands:'.', decimal:',', affixesStay: false});
    </script>
