									...
									<div class="" role="tabpanel" data-example-id="togglable-tabs">
										...
										<div id="myTabContent" class="tab-content">
											...
											<div role="tabpanel" class="tab-pane fade active in"
												...
												<form action="?m=sistema&c=categoria&a=cadastrar"
														...
														<div class="col-md-8 col-sm-12 col-xs-12 form-group">
															...
															<div class="col-md-9 col-sm-9 col-xs-12">
																<input type="text" name="descricao"
																	value="<?= (isset($data['categoria'][0]['descricao'])) ? $data['categoria'][0]['descricao'] : '' ?>"
																	class="form-control" placeholder="Descrição">
															</div>
														</div>
														<div class="col-md-8 col-sm-12 col-xs-12 form-group">
															<label class="control-label col-md-3 col-sm-3 col-xs-12">Ícone</label>
															<div class="col-md-9 col-sm-9 col-xs-12">
																<input type="text" name="icone"
																	value="<?= (isset($data['categoria'][0]['icone'])) ? $data['categoria'][0]['icone'] : '' ?>"
																	class="form-control" placeholder="Ícone">
															</div>
														</div>
														<div class="col-md-8 col-sm-12 col-xs-12 form-group">
															...
															<div class="col-md-9 col-sm-9 col-xs-12">
																<select class="form-control" name="categoria_pai">
																	<option value=""></option>
																	<option
																		value="<?= (isset($data['categoria'][0]['categoria_pai'])) ? $data['categoria'][0]['categoria_pai'] : '' ?>"><?= (isset($data['categoria'][0]['categoria_pai'])) ? dao('Core', 'Categoria')->getField('descricao', $data['categoria'][0]['categoria_pai']) : '' ?></option>
															...
															<div class="col-md-9 col-sm-9 col-xs-12">
																<div class="">
																	<label> <input type="checkbox" class="js-switch"
																		name="skyhub"  /> Inserir Categoria na SkyHub
																	</label>
																</div>
															</div>
														</div>
