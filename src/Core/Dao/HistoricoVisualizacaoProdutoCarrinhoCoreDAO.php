...
class HistoricoVisualizacaoProdutoCarrinhoCoreDAO extends Dao 
{
	 ...
	 */
	const TABLE = "historico_visualizacao_produto_carrinho";
	...
	*/
	...
	public function getAllFields(){
		return [
				...
				"id_produto",
				"id_cliente",
				"ultima_hora_envio_emal_recuperacao_carrinho",
				"ultima_data_envio_emal_recuperacao_carrinho",
				"data_expira_envio_email",
			];
	}
