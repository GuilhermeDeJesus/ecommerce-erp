...
<script>
    ...
    Mercadopago.setPublishableKey("<?=$publicKey;?>"); //AQUI USAR O PUBLIC KEY (https://www.mercadopago.com/mlb/account/credentials)
...
<div class="container">
    ...
    <h2 class="text-center mt-3 mb-5">Pagamento com Cartão de Crédito</h2>
    ...
    <div class="row">
        <div class="col">
            ...
            <form id="form1" action="autoriza_cartao.php" method="POST">
                ...
                <input type="hidden" name="produto" value="Produto Teste">
                <input type="hidden" name="qtde" value="1">
                <input type="hidden" name="total" class="total" value="1.50">
                <hr>

                <div class="form-group row">
                    <label class="col-form-label col-md-1">Total:</label>
                    <input type="text" name="total" class="form-control form-control-sm col-md-2 total" value="1.50" disabled>
                </div>
