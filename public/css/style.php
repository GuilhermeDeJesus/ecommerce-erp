...
.alireview-icon-like {
	background: url(../img/review-like.png?bab1d5c…) no-repeat;
...
.alireview-icon-unlike {
	background: url(../img/review-unlike.png?f78c0f8…) no-repeat;
	background-position: 0 0;
	display: inline-block;
	width: 13px;
	height: 13px;
...
.ali-flag-slc {
	text-align: center;
	background: url(../img/brazil.png?bab1d5c…) no-repeat;
	width: 24px;
	height: 24px;
	display: inline-block;
	vertical-align: middle;
...
.sft-measures td, .sft-measures th {
	padding: 8px 0;
...
.sft-measures .sft-ms-sizes.type2 {
	border-top: 0;
}
...
.no-btn :hover, .f-marca :hover, .f-marca a :hover, .no-btn a :hover {
	border: 1px solid <?=COR_LOJA?>;
	background: <?=COR_LOJA?>;
	color: #FFF;
}
...
.btn-produto-indisponivel :hover, .btn-produto-indisponivel:active {
	color: #CCC !important;
	outline: 0;
}
...
.menu-top-mobile {
	...
	background: #FFF;
	box-shadow: 0px 3px 3px 0px rgba(0, 0, 0, 0.3);
	ox-shadow: 10px 10px 8px <?=COR_LOJA?>;
}
...
.mobile-menu .sidenav {
	border-right: 0px solid <?=COR_LOJA?>;
	width: 0;
	height: 100%;
	position: fixed;
	z-index: 1;
...
.sobre .tab button:hover {
	border-bottom: 1px solid #d5d5d5;
	border-right: 1px solid #d5d5d5;
	border-left: 1px solid #d5d5d5;
}

.sobre .tab button.active {
	border-bottom: 1px solid #d5d5d5;
	border-right: 1px solid #d5d5d5;
	border-left: 1px solid #d5d5d5;
}
...
.button-tamanho:hover, .button-tamanho:focus {
	border-bottom-color: <?=COR_LOJA?>;
	background: #666;
	border: none;
	outline: none;
...
.btn-frete :hover, .btn-frete:active {
	color: #FFF !important;
	outline: 0;
}
...
.button-comprar-default a {
	color: #FFF;
}

.button-comprar-default :hover, .button-comprar-default:active {
	color: #FFF !important;
	outline: 0;
}
...
.class-search .inner-addon {
	position: relative;
}

.class-search .inner-addon .glyphicon {
	position: absolute;
	padding: 14px;
	pointer-events: none;
}

.class-search .left-addon .glyphicon {
	left: 0px;
}

.class-search .right-addon .glyphicon {
	right: 0px;
}

.class-search .left-addon input {
	padding-left: 30px;
}

.class-search .right-addon input {
	padding-right: 30px;
}
...
.modal-body.modal-body-sub_agile input[type="text"], .modal-body.modal-body-sub_agile input[type="email"],
...
.ban-top {
	...
	box-shadow: 0 3px 5px 0 rgba(102, 102, 102, 0.2);
	margin: 0 0 0 0;
	border-radius: 0px;
	background: #FFFFFF;
...
.carousel .item.item2 {
	background: -webkit-linear-gradient(rgba(23, 22, 23, 0.2),
		rgba(23, 22, 23, 0.5)), url(../img/banner1.jpg) no-repeat;
	background: -moz-linear-gradient(rgba(23, 22, 23, 0.2),
		rgba(23, 22, 23, 0.5)), url(../img/banner1.jpg) no-repeat;
...
.carousel .item.item3 {
	background: -webkit-linear-gradient(rgba(23, 22, 23, 0.2),
		rgba(23, 22, 23, 0.5)), url(../img/banner3.jpg) no-repeat;
	background: -moz-linear-gradient(rgba(23, 22, 23, 0.2),
		rgba(23, 22, 23, 0.5)), url(../img/banner3.jpg) no-repeat;
	background: -ms-linear-gradient(rgba(23, 22, 23, 0.2),
		rgba(23, 22, 23, 0.5)), url(../img/banner3.jpg) no-repeat;
...
.carousel .item.item4 {
	background: -webkit-linear-gradient(rgba(23, 22, 23, 0.2),
		rgba(23, 22, 23, 0.5)), url(../img/banner4.jpg) no-repeat;
	background: -moz-linear-gradient(rgba(23, 22, 23, 0.2),
		rgba(23, 22, 23, 0.5)), url(../img/banner4.jpg) no-repeat;
	background: -ms-linear-gradient(rgba(23, 22, 23, 0.2),
		rgba(23, 22, 23, 0.5)), url(../img/banner4.jpg) no-repeat;
	background: linear-gradient(rgba(23, 22, 23, 0.2), rgba(23, 22, 23, 0.5)),
		url(../img/banner4.jpg) no-repeat;
	background-size: cover;
}
...
.search-hotel form input[type="submit"] {
	background: url(../img/search.png) no-repeat 13px 11px <?=COR_LOJA?>;
	width: 44px;
	height: 39px;
	border: none;
	padding: 0;
...
/*-- //nuts --*/
.ads-grid, footer, .contact-w3l, .w3_wthree_agileits_icons, .typo,
	.faqs-w3l, .terms-of-use, .welcome, .about, .banner-bootom-w3-agileits,
	.privacy {
	padding: 1em 0;
}
/*-- tittle heading --*/
...
.information-wrapper input, .information-wrapper select {
	...
	outline: none;
	border: none;
	border-bottom: 1px solid <?=COR_LOJA?>;
...
.agileits_w3layouts_tab2 input[type="email"], .agileits_w3layouts_tab2 input[type="password"],
