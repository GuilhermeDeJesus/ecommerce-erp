...
class CanvasUtil
{
    ...
    public static function Instance($origem = '')
    {
        if (empty(self::$instance))
            self::$instance = new CanvasUtil($origem);
        else
     ...
     * Construtor
     *
     *            da imagem a ser carregada [opcional]
     * @return void
     *
     */
     ...
     *
     * @param
     *            String caminho da imagem a ser carregada
     ...
     *
     * @param
     *            Int x - posicao x do crop
     * @param
     *            Int y - posicao y do crop
     * @param
     *            Int w - width - larguraOrigem (by OctaAugusto)
     * @param
     *            Int h - height - alturaOrigem (by OctaAugusto)
     * @return Object instância atual do objeto, para métodos encadeados
     *        
     */
     ...
     * Redimensiona imagem
     *
     * @param Int $nova_largura
     *            valor em pixels da nova largura da imagem
     * @param Int $nova_altura
     *            valor em pixels da nova altura da imagem
     * @param String $tipo
     *            método para redimensionamento (padrão [vazio], preenchimento ou crop)
     * @return Object instância atual do objeto, para métodos encadeados
     *        
     */
...
elseif (($wm <= $hm)) {
     ...
     *
     * @param String $tipo
     *            tipo de espelhamento: h - horizontal, v - vertical
     * @return Object instância atual do objeto, para métodos encadeados
     *        
     */
...
elseif ('h' == $tipo) {
     ...
     * @param Int $x
     *            posição x do texto na imagem
     * @param Int $y
     *            posição y do texto na imagem
     * @param Array/String $cor_fundo
     *            array com cores RGB ou string com cor hexadecimal
     * @param Boolean $truetype
     *            true para utilizar fonte truetype, false para fonte do sistema
     * @param String $fonte
     *            nome da fonte truetype a ser utilizada
     * @return void
     *
     */
     ...
     *            valores pré-definidos (topo_esquerda, meio_centro etc.)
     ...
     * @param Int/String $x
     *            posição x da marca na imagem ou constante para marcaFixa()
     * @param Int/Sring $y
     *            posição y da marca na imagem ou constante para marcaFixa()
     * @return Boolean true/false dependendo do resultado da operação
     * @param Int $alfa
     *            valor para transparência (0-100)
     ...
     *            caminho da imagem de marca d'água
     * @param String $posicao
     *            posição/orientação fixa da marca d'água
     ...
     *
     * @param String $filtro
     *            constante/nome do filtro
     * @param Integer $quantidade
     *            número de vezes que o filtro deve ser aplicado
     *            utilizado em blur, edge, emboss, pixel e rascunho
     * @param $arg1, $arg2
     *            e $arg3 - ver manual da função imagefilter
     * @return Object instância atual do objeto, para métodos encadeados
     *        
     */
    ...
    public function converter($source, $dest, $marcadagua)
    {
        // Configuracoes da funcao
        $qualidade_miniatura = "80";
        $caminho_marcadagua = $marcadagua;
     ...
     *            caminho e nome do arquivo a serem criados
     * @param Int $qualidade
     *            qualidade da imagem no caso de JPEG (0-100)
     * @return void
     *
     */
